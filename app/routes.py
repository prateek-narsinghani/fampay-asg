...
def index():
    ...
    next_url = url_for('index', page=videos.next_num, search_query=form.search_query.data,
                   order_by=form.order_by.data, search_by=form.search_by.data,
                   sort=form.sort.data) if videos.has_next else None
    prev_url = url_for('index', page=videos.prev_num, search_query=form.search_query.data,
                    order_by=form.order_by.data, search_by=form.search_by.data,
